...
{
    Console.WriteLine("");
    Console.WriteLine("Ingrese la contraseña secreta, solo tiene 5 intentos");
    string contraseña = Convert.ToString(Console.ReadLine());
    int contador2 = 5;
    while (contraseña != "github555")
    {
        if (contador2 != 1)
        {
...
{
    Console.WriteLine("");
    Console.WriteLine("ingrese 10 numeros , veremos cual es el mayor de todos:");
...
{
    Console.WriteLine("");
    Console.WriteLine("Ingrese un número ,  veremos si es par o impar:");
...
void ejercicio9()
{
    Console.WriteLine("Ingrese una frase y vamos a ver cuantas vocales tiene");
...
{
    Console.WriteLine("");
    Console.WriteLine("Ingrese un numero del 1 al 12 y haremos su tabla ");
    ...
    {
        Console.WriteLine("El numero es mayor o menor a lo pedido ");
    }
}
...
void ejercicio11()
{
    ...
    {
        Console.WriteLine("");
        Console.WriteLine("Ingrese los numeros que vos quieras hasta q sumen todos 100");
...
{
    Console.WriteLine("");
    Console.WriteLine("Escriba una palabra y la separaremos en distintas lineas ");
...
void ejercicio15()
{
    ...
    if (contraseña1 != contraseña2)
    {
        ...
        while (cont1 != cont2)
        {
            Console.WriteLine("No coinciden las contraseñas");
            Console.WriteLine("Escriba la 1ra contraseña:");
...
{
    Console.WriteLine("");
    Console.WriteLine("Ingrese varios nombre hasta que un nombre contenga 10 o más caracteres):");
...
{
    Console.WriteLine("");
    Console.WriteLine("que ejercicio quiere realizar? del 1 a 18");
    ...
    Console.WriteLine("cerrar el programa escriba '0'");
    Console.WriteLine("");
    ...
    switch (menu)
    {
        ...
        default:
            Console.WriteLine("");
            Console.WriteLine("El numero no esta en la lista, ingrese otro");
            Console.WriteLine("");
            break;
    }
}
